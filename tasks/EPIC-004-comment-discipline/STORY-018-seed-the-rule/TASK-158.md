...
| `:10` | `# Run locally: bash .github/workflows/skills-lint.sh` — recoverable from the shebang plus the file's own path, and stated in `AGENTS.md` § Commands. No options or env hints, so it adds nothing | I |
