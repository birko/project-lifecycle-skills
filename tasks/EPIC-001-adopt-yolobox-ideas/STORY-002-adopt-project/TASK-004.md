...
- [ ] Confirm every proposal shows its evidence and that declining one leaves it unwritten. **Evidence half confirmed on Presenter (2026-08-18)** — every proposed rule carried a count and representative paths (`[142/148]`, `[5/5 pages]`, `[3 sections]`, and file:line for the resolution-order rule). The **decline half is still unexercised**: nothing inferred was declined in that run, so "an unconfirmed inference is dropped, not written as a guess" has never actually been tested
