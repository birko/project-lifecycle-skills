...
- **EPIC-002** Close-gate findings on the skill set — in-progress (31/55 tasks done) · `kind: review-intake`
  ...
  - STORY-016 The front doors under a cold drill — what the prose says versus what it does — in-progress (7/15)
    ...
    - [ ] [TASK-096](EPIC-002-close-gate-findings/STORY-016-front-doors-cold-drill/TASK-096.md) A conditional row cannot say what "here" means, or which kind of env var counts
