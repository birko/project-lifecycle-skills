...
- **EPIC-002** Close-gate findings on the skill set — in-progress (35/58 tasks done) · `kind: review-intake`
  ...
  - STORY-016 The front doors under a cold drill — what the prose says versus what it does — in-progress (10/18)
    ...
    - [ ] [TASK-097](EPIC-002-close-gate-findings/STORY-016-front-doors-cold-drill/TASK-097.md) `unknown` is the only container for two different situations, and one of them is not ignorance
    - [ ] [TASK-098](EPIC-002-close-gate-findings/STORY-016-front-doors-cold-drill/TASK-098.md) The adopted-repo brief describes the substitute and never the original (P3)
    - [ ] [TASK-099](EPIC-002-close-gate-findings/STORY-016-front-doors-cold-drill/TASK-099.md) A row that names two artifacts never says whether the second carries its own state (P3)
