...
/specs — capability specs harvested from code, reviewed as diffs
  ...
  /specs regen --story S-NNN  areas touched by a closed story (the /tasks close hook)
  /specs regen --feature F-NNN  areas touched by a feature (the /feature review hook)
